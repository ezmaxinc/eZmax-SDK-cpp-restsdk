...
/*
 * Apikey_createObject_v1_Response.h
 *
 * Response for the /1/object/apikey/createObject API Request
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Apikey_createObject_v1_Response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Apikey_createObject_v1_Response_H_
...
/// Response for the /1/object/apikey/createObject API Request
/// </summary>
class  Apikey_createObject_v1_Response
    : public ModelBase
{
public:
    Apikey_createObject_v1_Response();
    virtual ~Apikey_createObject_v1_Response();
    ...
    /////////////////////////////////////////////
    /// Apikey_createObject_v1_Response members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Apikey_createObject_v1_Response_mPayload> getMPayload() const;
    bool mPayloadIsSet() const;
    void unsetMPayload();

    void setMPayload(const std::shared_ptr<Apikey_createObject_v1_Response_mPayload>& value);
...
protected:
    std::shared_ptr<Apikey_createObject_v1_Response_mPayload> m_MPayload;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Apikey_createObject_v1_Response_H_ */
