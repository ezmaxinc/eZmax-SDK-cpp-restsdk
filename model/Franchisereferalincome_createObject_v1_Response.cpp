...
void Franchisereferalincome_createObject_v1_Response::validate()
{
    // TODO: implement validation
}

web::json::value Franchisereferalincome_createObject_v1_Response::toJson() const
{
...
bool Franchisereferalincome_createObject_v1_Response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("mPayload")))
    {
        ...
        {
            std::shared_ptr<Franchisereferalincome_createObject_v1_Response_mPayload> refVal_mPayload;
...
void Franchisereferalincome_createObject_v1_Response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Franchisereferalincome_createObject_v1_Response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<Franchisereferalincome_createObject_v1_Response_mPayload> Franchisereferalincome_createObject_v1_Response::getMPayload() const
{
    return m_MPayload;
}

void Franchisereferalincome_createObject_v1_Response::setMPayload(const std::shared_ptr<Franchisereferalincome_createObject_v1_Response_mPayload>& value)
{
    m_MPayload = value;
    m_MPayloadIsSet = true;
}

bool Franchisereferalincome_createObject_v1_Response::mPayloadIsSet() const
{
    return m_MPayloadIsSet;
}

void Franchisereferalincome_createObject_v1_Response::unsetMPayload()
{
    m_MPayloadIsSet = false;
}
std::shared_ptr<Common_Response_objDebugPayload> Franchisereferalincome_createObject_v1_Response::getObjDebugPayload() const
{
    return m_ObjDebugPayload;
}

void Franchisereferalincome_createObject_v1_Response::setObjDebugPayload(const std::shared_ptr<Common_Response_objDebugPayload>& value)
{
    m_ObjDebugPayload = value;
    m_ObjDebugPayloadIsSet = true;
}

bool Franchisereferalincome_createObject_v1_Response::objDebugPayloadIsSet() const
{
    return m_ObjDebugPayloadIsSet;
}

void Franchisereferalincome_createObject_v1_Response::unsetObjDebugPayload()
{
    m_ObjDebugPayloadIsSet = false;
}
std::shared_ptr<Common_Response_objDebug> Franchisereferalincome_createObject_v1_Response::getObjDebug() const
{
    return m_ObjDebug;
}

void Franchisereferalincome_createObject_v1_Response::setObjDebug(const std::shared_ptr<Common_Response_objDebug>& value)
{
    m_ObjDebug = value;
    m_ObjDebugIsSet = true;
}

bool Franchisereferalincome_createObject_v1_Response::objDebugIsSet() const
{
    return m_ObjDebugIsSet;
}

void Franchisereferalincome_createObject_v1_Response::unsetObjDebug()
{
    m_ObjDebugIsSet = false;
}
}
