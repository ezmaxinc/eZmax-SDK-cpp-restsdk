...
void Ezsignfolder_send_v1_Response::validate()
{
    // TODO: implement validation
}

web::json::value Ezsignfolder_send_v1_Response::toJson() const
{
...
bool Ezsignfolder_send_v1_Response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ezsignfolder_send_v1_Response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ezsignfolder_send_v1_Response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<Common_Response_objDebugPayload> Ezsignfolder_send_v1_Response::getObjDebugPayload() const
{
    return m_ObjDebugPayload;
}

void Ezsignfolder_send_v1_Response::setObjDebugPayload(const std::shared_ptr<Common_Response_objDebugPayload>& value)
{
    m_ObjDebugPayload = value;
    m_ObjDebugPayloadIsSet = true;
}

bool Ezsignfolder_send_v1_Response::objDebugPayloadIsSet() const
{
    return m_ObjDebugPayloadIsSet;
}

void Ezsignfolder_send_v1_Response::unsetObjDebugPayload()
{
    m_ObjDebugPayloadIsSet = false;
}
std::shared_ptr<Common_Response_objDebug> Ezsignfolder_send_v1_Response::getObjDebug() const
{
    return m_ObjDebug;
}

void Ezsignfolder_send_v1_Response::setObjDebug(const std::shared_ptr<Common_Response_objDebug>& value)
{
    m_ObjDebug = value;
    m_ObjDebugIsSet = true;
}

bool Ezsignfolder_send_v1_Response::objDebugIsSet() const
{
    return m_ObjDebugIsSet;
}

void Ezsignfolder_send_v1_Response::unsetObjDebug()
{
    m_ObjDebugIsSet = false;
}
}
