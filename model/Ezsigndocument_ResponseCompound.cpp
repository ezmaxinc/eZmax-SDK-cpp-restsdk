...
utility::string_t Ezsigndocument_ResponseCompound::getSEzsigndocumentFilename() const
{
    return m_SEzsigndocumentFilename;
}

void Ezsigndocument_ResponseCompound::setSEzsigndocumentFilename(const utility::string_t& value)
{
    m_SEzsigndocumentFilename = value;
    m_SEzsigndocumentFilenameIsSet = true;
}

bool Ezsigndocument_ResponseCompound::sEzsigndocumentFilenameIsSet() const
{
    return m_SEzsigndocumentFilenameIsSet;
}

void Ezsigndocument_ResponseCompound::unsetSEzsigndocumentFilename()
{
    m_SEzsigndocumentFilenameIsSet = false;
}
