...
Authenticate_authenticate_v2_Response::Authenticate_authenticate_v2_Response()
{
...
void Authenticate_authenticate_v2_Response::validate()
{
    // TODO: implement validation
}

web::json::value Authenticate_authenticate_v2_Response::toJson() const
{
...
bool Authenticate_authenticate_v2_Response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("mPayload")))
    {
        ...
        {
            std::shared_ptr<Authenticate_authenticate_v2_Response_mPayload> refVal_mPayload;
...
void Authenticate_authenticate_v2_Response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Authenticate_authenticate_v2_Response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<Authenticate_authenticate_v2_Response_mPayload> Authenticate_authenticate_v2_Response::getMPayload() const
{
    return m_MPayload;
}

void Authenticate_authenticate_v2_Response::setMPayload(const std::shared_ptr<Authenticate_authenticate_v2_Response_mPayload>& value)
{
    m_MPayload = value;
    m_MPayloadIsSet = true;
}

bool Authenticate_authenticate_v2_Response::mPayloadIsSet() const
{
    return m_MPayloadIsSet;
}

void Authenticate_authenticate_v2_Response::unsetMPayload()
{
    m_MPayloadIsSet = false;
}
std::shared_ptr<Common_Response_objDebugPayload> Authenticate_authenticate_v2_Response::getObjDebugPayload() const
{
    return m_ObjDebugPayload;
}

void Authenticate_authenticate_v2_Response::setObjDebugPayload(const std::shared_ptr<Common_Response_objDebugPayload>& value)
{
    m_ObjDebugPayload = value;
    m_ObjDebugPayloadIsSet = true;
}

bool Authenticate_authenticate_v2_Response::objDebugPayloadIsSet() const
{
    return m_ObjDebugPayloadIsSet;
}

void Authenticate_authenticate_v2_Response::unsetObjDebugPayload()
{
    m_ObjDebugPayloadIsSet = false;
}
std::shared_ptr<Common_Response_objDebug> Authenticate_authenticate_v2_Response::getObjDebug() const
{
    return m_ObjDebug;
}

void Authenticate_authenticate_v2_Response::setObjDebug(const std::shared_ptr<Common_Response_objDebug>& value)
{
    m_ObjDebug = value;
    m_ObjDebugIsSet = true;
}

bool Authenticate_authenticate_v2_Response::objDebugIsSet() const
{
    return m_ObjDebugIsSet;
}

void Authenticate_authenticate_v2_Response::unsetObjDebug()
{
    m_ObjDebugIsSet = false;
}
}
