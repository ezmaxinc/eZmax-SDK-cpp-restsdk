...
User_Response_allOf::User_Response_allOf()
{
    m_PkiUserID = 0;
...
void User_Response_allOf::validate()
{
    // TODO: implement validation
}

web::json::value User_Response_allOf::toJson() const
{
...
bool User_Response_allOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void User_Response_allOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool User_Response_allOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t User_Response_allOf::getPkiUserID() const
{
    return m_PkiUserID;
}

void User_Response_allOf::setPkiUserID(int32_t value)
{
    m_PkiUserID = value;
    m_PkiUserIDIsSet = true;
}

bool User_Response_allOf::pkiUserIDIsSet() const
{
    return m_PkiUserIDIsSet;
}

void User_Response_allOf::unsetPkiUserID()
{
    m_PkiUserIDIsSet = false;
}
int32_t User_Response_allOf::getFkiLanguageID() const
{
    return m_FkiLanguageID;
}

void User_Response_allOf::setFkiLanguageID(int32_t value)
{
    m_FkiLanguageID = value;
    m_FkiLanguageIDIsSet = true;
}

bool User_Response_allOf::fkiLanguageIDIsSet() const
{
    return m_FkiLanguageIDIsSet;
}

void User_Response_allOf::unsetFkiLanguageID()
{
    m_FkiLanguageIDIsSet = false;
}
std::shared_ptr<Field_eUserType> User_Response_allOf::getEUserType() const
{
    return m_EUserType;
}

void User_Response_allOf::setEUserType(const std::shared_ptr<Field_eUserType>& value)
{
    m_EUserType = value;
    m_EUserTypeIsSet = true;
}

bool User_Response_allOf::eUserTypeIsSet() const
{
    return m_EUserTypeIsSet;
}

void User_Response_allOf::unsetEUserType()
{
    m_EUserTypeIsSet = false;
}
utility::string_t User_Response_allOf::getSUserFirstname() const
{
    return m_SUserFirstname;
}

void User_Response_allOf::setSUserFirstname(const utility::string_t& value)
{
    m_SUserFirstname = value;
    m_SUserFirstnameIsSet = true;
}

bool User_Response_allOf::sUserFirstnameIsSet() const
{
    return m_SUserFirstnameIsSet;
}

void User_Response_allOf::unsetSUserFirstname()
{
    m_SUserFirstnameIsSet = false;
}
utility::string_t User_Response_allOf::getSUserLastname() const
{
    return m_SUserLastname;
}

void User_Response_allOf::setSUserLastname(const utility::string_t& value)
{
    m_SUserLastname = value;
    m_SUserLastnameIsSet = true;
}

bool User_Response_allOf::sUserLastnameIsSet() const
{
    return m_SUserLastnameIsSet;
}

void User_Response_allOf::unsetSUserLastname()
{
    m_SUserLastnameIsSet = false;
}
utility::string_t User_Response_allOf::getSUserLoginname() const
{
    return m_SUserLoginname;
}

void User_Response_allOf::setSUserLoginname(const utility::string_t& value)
{
    m_SUserLoginname = value;
    m_SUserLoginnameIsSet = true;
}

bool User_Response_allOf::sUserLoginnameIsSet() const
{
    return m_SUserLoginnameIsSet;
}

void User_Response_allOf::unsetSUserLoginname()
{
    m_SUserLoginnameIsSet = false;
}
std::shared_ptr<Common_Audit> User_Response_allOf::getObjAudit() const
{
    return m_ObjAudit;
}

void User_Response_allOf::setObjAudit(const std::shared_ptr<Common_Audit>& value)
{
    m_ObjAudit = value;
    m_ObjAuditIsSet = true;
}

bool User_Response_allOf::objAuditIsSet() const
{
    return m_ObjAuditIsSet;
}

void User_Response_allOf::unsetObjAudit()
{
    m_ObjAuditIsSet = false;
}
}
