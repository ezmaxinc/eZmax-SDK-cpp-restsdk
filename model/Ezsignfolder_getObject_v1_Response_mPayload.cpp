...
void Ezsignfolder_getObject_v1_Response_mPayload::validate()
{
    // TODO: implement validation
}

web::json::value Ezsignfolder_getObject_v1_Response_mPayload::toJson() const
{
...
bool Ezsignfolder_getObject_v1_Response_mPayload::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Ezsignfolder_getObject_v1_Response_mPayload::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Ezsignfolder_getObject_v1_Response_mPayload::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t Ezsignfolder_getObject_v1_Response_mPayload::getFkiEzsignfoldertypeID() const
{
    return m_FkiEzsignfoldertypeID;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setFkiEzsignfoldertypeID(int32_t value)
{
    m_FkiEzsignfoldertypeID = value;
    m_FkiEzsignfoldertypeIDIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::fkiEzsignfoldertypeIDIsSet() const
{
    return m_FkiEzsignfoldertypeIDIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetFkiEzsignfoldertypeID()
{
    m_FkiEzsignfoldertypeIDIsSet = false;
}
int32_t Ezsignfolder_getObject_v1_Response_mPayload::getFkiEzsigntsarequirementID() const
{
    return m_FkiEzsigntsarequirementID;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setFkiEzsigntsarequirementID(int32_t value)
{
    m_FkiEzsigntsarequirementID = value;
    m_FkiEzsigntsarequirementIDIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::fkiEzsigntsarequirementIDIsSet() const
{
    return m_FkiEzsigntsarequirementIDIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetFkiEzsigntsarequirementID()
{
    m_FkiEzsigntsarequirementIDIsSet = false;
}
utility::string_t Ezsignfolder_getObject_v1_Response_mPayload::getSEzsignfolderDescription() const
{
    return m_SEzsignfolderDescription;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setSEzsignfolderDescription(const utility::string_t& value)
{
    m_SEzsignfolderDescription = value;
    m_SEzsignfolderDescriptionIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::sEzsignfolderDescriptionIsSet() const
{
    return m_SEzsignfolderDescriptionIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetSEzsignfolderDescription()
{
    m_SEzsignfolderDescriptionIsSet = false;
}
utility::string_t Ezsignfolder_getObject_v1_Response_mPayload::getTEzsignfolderNote() const
{
    return m_TEzsignfolderNote;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setTEzsignfolderNote(const utility::string_t& value)
{
    m_TEzsignfolderNote = value;
    m_TEzsignfolderNoteIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::tEzsignfolderNoteIsSet() const
{
    return m_TEzsignfolderNoteIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetTEzsignfolderNote()
{
    m_TEzsignfolderNoteIsSet = false;
}
std::shared_ptr<Field_eEzsignfolderSendreminderfrequency> Ezsignfolder_getObject_v1_Response_mPayload::getEEzsignfolderSendreminderfrequency() const
{
    return m_EEzsignfolderSendreminderfrequency;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setEEzsignfolderSendreminderfrequency(const std::shared_ptr<Field_eEzsignfolderSendreminderfrequency>& value)
{
    m_EEzsignfolderSendreminderfrequency = value;
    m_EEzsignfolderSendreminderfrequencyIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::eEzsignfolderSendreminderfrequencyIsSet() const
{
    return m_EEzsignfolderSendreminderfrequencyIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetEEzsignfolderSendreminderfrequency()
{
    m_EEzsignfolderSendreminderfrequencyIsSet = false;
}
int32_t Ezsignfolder_getObject_v1_Response_mPayload::getPkiEzsignfolderID() const
{
    return m_PkiEzsignfolderID;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setPkiEzsignfolderID(int32_t value)
{
    m_PkiEzsignfolderID = value;
    m_PkiEzsignfolderIDIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::pkiEzsignfolderIDIsSet() const
{
    return m_PkiEzsignfolderIDIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetPkiEzsignfolderID()
{
    m_PkiEzsignfolderIDIsSet = false;
}
utility::string_t Ezsignfolder_getObject_v1_Response_mPayload::getDtEzsignfolderSentdate() const
{
    return m_DtEzsignfolderSentdate;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setDtEzsignfolderSentdate(const utility::string_t& value)
{
    m_DtEzsignfolderSentdate = value;
    m_DtEzsignfolderSentdateIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::dtEzsignfolderSentdateIsSet() const
{
    return m_DtEzsignfolderSentdateIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetDtEzsignfolderSentdate()
{
    m_DtEzsignfolderSentdateIsSet = false;
}
std::shared_ptr<Field_eEzsignfolderStep> Ezsignfolder_getObject_v1_Response_mPayload::getEEzsignfolderStep() const
{
    return m_EEzsignfolderStep;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setEEzsignfolderStep(const std::shared_ptr<Field_eEzsignfolderStep>& value)
{
    m_EEzsignfolderStep = value;
    m_EEzsignfolderStepIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::eEzsignfolderStepIsSet() const
{
    return m_EEzsignfolderStepIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetEEzsignfolderStep()
{
    m_EEzsignfolderStepIsSet = false;
}
utility::string_t Ezsignfolder_getObject_v1_Response_mPayload::getDtEzsignfolderClose() const
{
    return m_DtEzsignfolderClose;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setDtEzsignfolderClose(const utility::string_t& value)
{
    m_DtEzsignfolderClose = value;
    m_DtEzsignfolderCloseIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::dtEzsignfolderCloseIsSet() const
{
    return m_DtEzsignfolderCloseIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetDtEzsignfolderClose()
{
    m_DtEzsignfolderCloseIsSet = false;
}
std::shared_ptr<Common_Audit> Ezsignfolder_getObject_v1_Response_mPayload::getObjAudit() const
{
    return m_ObjAudit;
}

void Ezsignfolder_getObject_v1_Response_mPayload::setObjAudit(const std::shared_ptr<Common_Audit>& value)
{
    m_ObjAudit = value;
    m_ObjAuditIsSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::objAuditIsSet() const
{
    return m_ObjAuditIsSet;
}

void Ezsignfolder_getObject_v1_Response_mPayload::unsetObjAudit()
{
    m_ObjAuditIsSet = false;
}
}
