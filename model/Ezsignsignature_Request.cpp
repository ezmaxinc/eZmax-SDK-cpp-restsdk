...
std::shared_ptr<Field_eEzsignsignatureType> Ezsignsignature_Request::getEEzsignsignatureType() const
{
    return m_EEzsignsignatureType;
}

void Ezsignsignature_Request::setEEzsignsignatureType(const std::shared_ptr<Field_eEzsignsignatureType>& value)
{
