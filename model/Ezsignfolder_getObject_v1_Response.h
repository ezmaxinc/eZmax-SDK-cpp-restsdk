...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Ezsignfolder_getObject_v1_Response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Ezsignfolder_getObject_v1_Response_H_
...
/// Response for the /1/object/ezsignfolder/getObject API Request
/// </summary>
class  Ezsignfolder_getObject_v1_Response
    : public ModelBase
{
public:
    Ezsignfolder_getObject_v1_Response();
    virtual ~Ezsignfolder_getObject_v1_Response();
    ...
    /////////////////////////////////////////////
    /// Ezsignfolder_getObject_v1_Response members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Ezsignfolder_getObject_v1_Response_mPayload> getMPayload() const;
    bool mPayloadIsSet() const;
    void unsetMPayload();

    void setMPayload(const std::shared_ptr<Ezsignfolder_getObject_v1_Response_mPayload>& value);
...
protected:
    std::shared_ptr<Ezsignfolder_getObject_v1_Response_mPayload> m_MPayload;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Ezsignfolder_getObject_v1_Response_H_ */
