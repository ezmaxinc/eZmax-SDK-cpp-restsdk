...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Ezsignsignature_createObject_v1_Response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Ezsignsignature_createObject_v1_Response_H_
...
/// Response for the /1/object/ezsignsignature/createObject API Request
/// </summary>
class  Ezsignsignature_createObject_v1_Response
    : public ModelBase
{
public:
    Ezsignsignature_createObject_v1_Response();
    virtual ~Ezsignsignature_createObject_v1_Response();
    ...
    /////////////////////////////////////////////
    /// Ezsignsignature_createObject_v1_Response members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Ezsignsignature_createObject_v1_Response_mPayload> getMPayload() const;
    bool mPayloadIsSet() const;
    void unsetMPayload();

    void setMPayload(const std::shared_ptr<Ezsignsignature_createObject_v1_Response_mPayload>& value);
...
protected:
    std::shared_ptr<Ezsignsignature_createObject_v1_Response_mPayload> m_MPayload;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Ezsignsignature_createObject_v1_Response_H_ */
