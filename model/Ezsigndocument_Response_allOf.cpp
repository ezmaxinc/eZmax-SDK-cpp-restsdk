...
utility::string_t Ezsigndocument_Response_allOf::getSEzsigndocumentFilename() const
{
    return m_SEzsigndocumentFilename;
}

void Ezsigndocument_Response_allOf::setSEzsigndocumentFilename(const utility::string_t& value)
{
    m_SEzsigndocumentFilename = value;
    m_SEzsigndocumentFilenameIsSet = true;
}

bool Ezsigndocument_Response_allOf::sEzsigndocumentFilenameIsSet() const
{
    return m_SEzsigndocumentFilenameIsSet;
}

void Ezsigndocument_Response_allOf::unsetSEzsigndocumentFilename()
{
    m_SEzsigndocumentFilenameIsSet = false;
}
