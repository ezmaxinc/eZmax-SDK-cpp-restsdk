...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Authenticate_authenticate_v2_Response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Authenticate_authenticate_v2_Response_H_
...
/// Response for the /2/module/authenticate/authenticate API Request
/// </summary>
class  Authenticate_authenticate_v2_Response
    : public ModelBase
{
public:
    Authenticate_authenticate_v2_Response();
    virtual ~Authenticate_authenticate_v2_Response();
    ...
    /////////////////////////////////////////////
    /// Authenticate_authenticate_v2_Response members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Authenticate_authenticate_v2_Response_mPayload> getMPayload() const;
    bool mPayloadIsSet() const;
    void unsetMPayload();

    void setMPayload(const std::shared_ptr<Authenticate_authenticate_v2_Response_mPayload>& value);
...
protected:
    std::shared_ptr<Authenticate_authenticate_v2_Response_mPayload> m_MPayload;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Authenticate_authenticate_v2_Response_H_ */
