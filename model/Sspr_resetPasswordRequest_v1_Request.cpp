...
Sspr_resetPasswordRequest_v1_Request::Sspr_resetPasswordRequest_v1_Request()
{
...
void Sspr_resetPasswordRequest_v1_Request::validate()
{
    // TODO: implement validation
}

web::json::value Sspr_resetPasswordRequest_v1_Request::toJson() const
{
...
bool Sspr_resetPasswordRequest_v1_Request::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Sspr_resetPasswordRequest_v1_Request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Sspr_resetPasswordRequest_v1_Request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
utility::string_t Sspr_resetPasswordRequest_v1_Request::getPksCustomerCode() const
{
    return m_PksCustomerCode;
}

void Sspr_resetPasswordRequest_v1_Request::setPksCustomerCode(const utility::string_t& value)
{
    m_PksCustomerCode = value;
    m_PksCustomerCodeIsSet = true;
}

bool Sspr_resetPasswordRequest_v1_Request::pksCustomerCodeIsSet() const
{
    return m_PksCustomerCodeIsSet;
}

void Sspr_resetPasswordRequest_v1_Request::unsetPksCustomerCode()
{
    m_PksCustomerCodeIsSet = false;
}
int32_t Sspr_resetPasswordRequest_v1_Request::getFkiLanguageID() const
{
    return m_FkiLanguageID;
}

void Sspr_resetPasswordRequest_v1_Request::setFkiLanguageID(int32_t value)
{
    m_FkiLanguageID = value;
    m_FkiLanguageIDIsSet = true;
}

bool Sspr_resetPasswordRequest_v1_Request::fkiLanguageIDIsSet() const
{
    return m_FkiLanguageIDIsSet;
}

void Sspr_resetPasswordRequest_v1_Request::unsetFkiLanguageID()
{
    m_FkiLanguageIDIsSet = false;
}
std::shared_ptr<Field_eUserTypeSSPR> Sspr_resetPasswordRequest_v1_Request::getEUserTypeSSPR() const
{
    return m_EUserTypeSSPR;
}

void Sspr_resetPasswordRequest_v1_Request::setEUserTypeSSPR(const std::shared_ptr<Field_eUserTypeSSPR>& value)
{
    m_EUserTypeSSPR = value;
    m_EUserTypeSSPRIsSet = true;
}

bool Sspr_resetPasswordRequest_v1_Request::eUserTypeSSPRIsSet() const
{
    return m_EUserTypeSSPRIsSet;
}

void Sspr_resetPasswordRequest_v1_Request::unsetEUserTypeSSPR()
{
    m_EUserTypeSSPRIsSet = false;
}
utility::string_t Sspr_resetPasswordRequest_v1_Request::getSEmailAddress() const
{
    return m_SEmailAddress;
}

void Sspr_resetPasswordRequest_v1_Request::setSEmailAddress(const utility::string_t& value)
{
    m_SEmailAddress = value;
    m_SEmailAddressIsSet = true;
}

bool Sspr_resetPasswordRequest_v1_Request::sEmailAddressIsSet() const
{
    return m_SEmailAddressIsSet;
}

void Sspr_resetPasswordRequest_v1_Request::unsetSEmailAddress()
{
    m_SEmailAddressIsSet = false;
}
utility::string_t Sspr_resetPasswordRequest_v1_Request::getSUserLoginname() const
{
    return m_SUserLoginname;
}

void Sspr_resetPasswordRequest_v1_Request::setSUserLoginname(const utility::string_t& value)
{
    m_SUserLoginname = value;
    m_SUserLoginnameIsSet = true;
}

bool Sspr_resetPasswordRequest_v1_Request::sUserLoginnameIsSet() const
{
    return m_SUserLoginnameIsSet;
}

void Sspr_resetPasswordRequest_v1_Request::unsetSUserLoginname()
{
    m_SUserLoginnameIsSet = false;
}
}
