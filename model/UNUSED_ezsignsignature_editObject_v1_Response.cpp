...
#include "UNUSED_ezsignsignature_editObject_v1_Response.h"
...
UNUSED_ezsignsignature_editObject_v1_Response::UNUSED_ezsignsignature_editObject_v1_Response()
{
...
void UNUSED_ezsignsignature_editObject_v1_Response::validate()
{
    // TODO: implement validation
}

web::json::value UNUSED_ezsignsignature_editObject_v1_Response::toJson() const
{
...
bool UNUSED_ezsignsignature_editObject_v1_Response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UNUSED_ezsignsignature_editObject_v1_Response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UNUSED_ezsignsignature_editObject_v1_Response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
std::shared_ptr<Common_Response_objDebugPayload> UNUSED_ezsignsignature_editObject_v1_Response::getObjDebugPayload() const
{
    return m_ObjDebugPayload;
}

void UNUSED_ezsignsignature_editObject_v1_Response::setObjDebugPayload(const std::shared_ptr<Common_Response_objDebugPayload>& value)
{
    m_ObjDebugPayload = value;
    m_ObjDebugPayloadIsSet = true;
}

bool UNUSED_ezsignsignature_editObject_v1_Response::objDebugPayloadIsSet() const
{
    return m_ObjDebugPayloadIsSet;
}

void UNUSED_ezsignsignature_editObject_v1_Response::unsetObjDebugPayload()
{
    m_ObjDebugPayloadIsSet = false;
}
std::shared_ptr<Common_Response_objDebug> UNUSED_ezsignsignature_editObject_v1_Response::getObjDebug() const
{
    return m_ObjDebug;
}

void UNUSED_ezsignsignature_editObject_v1_Response::setObjDebug(const std::shared_ptr<Common_Response_objDebug>& value)
{
    m_ObjDebug = value;
    m_ObjDebugIsSet = true;
}

bool UNUSED_ezsignsignature_editObject_v1_Response::objDebugIsSet() const
{
    return m_ObjDebugIsSet;
}

void UNUSED_ezsignsignature_editObject_v1_Response::unsetObjDebug()
{
    m_ObjDebugIsSet = false;
}
}
