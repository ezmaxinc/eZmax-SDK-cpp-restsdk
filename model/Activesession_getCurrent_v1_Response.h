...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Activesession_getCurrent_v1_Response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Activesession_getCurrent_v1_Response_H_
...
/// Response for the /1/object/activesession/getCurrent API Request
/// </summary>
class  Activesession_getCurrent_v1_Response
    : public ModelBase
{
public:
    Activesession_getCurrent_v1_Response();
    virtual ~Activesession_getCurrent_v1_Response();
    ...
    /////////////////////////////////////////////
    /// Activesession_getCurrent_v1_Response members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Activesession_getCurrent_v1_Response_mPayload> getMPayload() const;
    bool mPayloadIsSet() const;
    void unsetMPayload();

    void setMPayload(const std::shared_ptr<Activesession_getCurrent_v1_Response_mPayload>& value);
...
protected:
    std::shared_ptr<Activesession_getCurrent_v1_Response_mPayload> m_MPayload;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Activesession_getCurrent_v1_Response_H_ */
